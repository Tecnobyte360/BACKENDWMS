<div x-data="{
    ...
    class="transform-gpu fixed overflow-x-hidden overflow-y-auto inset-0 z-50 items-center justify-center top-4 md:inset-0 h-modal sm:h-full">
        <div class="relative w-full h-full">
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 dark:bg-gray-900/60 backdrop-blur-sm">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-md">
                <h2 class="text-2xl font-bold mb-5 text-gray-800 dark:text-white text-center">
                    <i class="fa-solid fa-key text-violet-600 mr-2"></i> Crear Nuevo Permiso
                </h2>
                ...
                <div class="space-y-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" wire:model.lazy="name"
                            ...
                            @error('name') border-red-500 bg-red-50 focus:ring-red-300 focus:border-red-500
                    ...
                    <div class="relative">
                        ...
                        <textarea wire:model.lazy="description"
                            ...
                            rows="3"
                            class="w-full px-4 py-3 rounded-2xl border transition-all shadow-inner
                            @error('description') border-red-500 bg-red-50 focus:ring-red-300 focus:border-red-500
                            @else border-gray-300 focus:ring-violet-300 focus:border-violet-500 @enderror
                            dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:ring-4"
                            placeholder="Describe el permiso..."></textarea>
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    ...
                    <button wire:click="store" wire:loading.attr="disabled"
                        ...
                        <span>Guardar</span>
                        <svg wire:loading wire:target="store" class="animate-spin h-4 w-4 ml-2 text-white"
            ...
            <div class="fixed inset-0 z-50 overflow-y-auto">
                <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div class="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                        ...
                        wire:click="update"
                        wire:loading.attr="disabled"
                        class="inline-flex items-center justify-center w-full px-5 py-2 text-sm font-medium text-white transition bg-gray-600 border border-transparent rounded-xl shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 sm:w-auto"
                    >
